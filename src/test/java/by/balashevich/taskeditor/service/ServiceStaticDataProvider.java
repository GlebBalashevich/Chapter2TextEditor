...
public class ServiceStaticDataProvider {

    @DataProvider(name = "textComponentSortData")
    public static Object[][] createTextComponentSortData() {
        ...
        List<BaseComponent> sortedText = new ArrayList<>();
        sortedText.add(paragraph3);
        sortedText.add(paragraph1);
        sortedText.add(paragraph2);

        return new Object[][]{
                {text, sortedText},
                {new TextComponent(ComponentType.ATOMIC), new ArrayList<>()}
        };
    }

    @DataProvider(name = "paragraphComponentSortData")
    public static Object[][] createParagraphComponentSortData() {
        ...
        List<BaseComponent> sortedSentences = new ArrayList<>();
        sortedSentences.add(sentence3component);
        sortedSentences.add(sentence1component);
        sortedSentences.add(sentence2component);

        return new Object[][]{
                {paragraph, sortedSentences},
                {new TextComponent(ComponentType.LEXEME), new ArrayList<>()},
        };
    }

    @DataProvider(name = "lexemesComponentSortData")
    public static Object[][] createLexemesComponentSortData() {
        ...
        lexeme5.add(new AtomicComponent("t", AtomicType.SYMBOL));
        lexeme5.add(new AtomicComponent("t", AtomicType.SYMBOL));
        ...
        lexeme7.add(new AtomicComponent("t", AtomicType.SYMBOL));
        lexeme7.add(new AtomicComponent("o", AtomicType.SYMBOL));
        lexeme7.add(new AtomicComponent("t", AtomicType.SYMBOL));
        lexeme7.add(new AtomicComponent("t", AtomicType.SYMBOL));
        ...
        List<BaseComponent> sortedLexemes = new ArrayList<>();
        sortedLexemes.add(lexemeComponent3);
        sortedLexemes.add(lexemeComponent1);
        sortedLexemes.add(lexemeComponent6);
        sortedLexemes.add(lexemeComponent4);
        sortedLexemes.add(lexemeComponent8);
        sortedLexemes.add(lexemeComponent2);
        sortedLexemes.add(lexemeComponent5);
        sortedLexemes.add(lexemeComponent7);

        return new Object[][]{
                {sentenceComponent, 't', sortedLexemes},
                {new TextComponent(ComponentType.WHOLE_TEXT), 't', new ArrayList<>()},
        };
    }
}
